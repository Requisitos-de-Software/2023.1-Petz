...
- Importantes e urgentes: quando os clientes necessitam do requisito e não podem esperar por ele (**alta prioridade**)[1].
- Importantes e não urgentes: quando os clientes necessitam do requisito mas podem esperar por ele (**média prioridade**)[1].
- Não importantes e não urgentes: quando os clientes não necessitam do requisito e podem esperar por ele (**baixa prioridade**)[1].
...
A partir da priorização realizada, foram construídas as tabelas 1, 2 e 3, onde estão marcados os requisitos de alta, média e baixa prioridade, respectivamente [2].
...
Nesta priorização, os requisitos não executados estão descritos na tabela 4 sob a justificativa já detalhada na [introdução](#1-introducao) deste artefato.
...
> [2] Lichess. Priorização de requisitos. Disponível no [link](https://requisitos-de-software.github.io/2022.2-Lichess/elicitacao/priorizacao/). Acesso em: 30 abr. 2023.
...
| ------ | -------- | -------------------------------- | ------------- | ----------- |
| `1.0`  | 30/04/23 | Criação da página de priorizaçao | Felipe Corrêa | Pedro Muniz |
