...
## 1. Introdução
Este documento tem como objetivo a sumarização das origens dos requisitos elicitados pela equipe durante o desenvolvimento do projeto. Fazendo assim com que um leitor possa se orientar na navegação pelo projeto, possuindo para isso hiperlinks para os art[efat](#efat)os e requisitos r[efer](#efer)enciados.

## 2. Metodologia
Além das origens dos requisitos listados, para a representação das rastrabilidades será utilizado o meta modelo proposto por Toranzo, o qual divide os elos de rastreabilidade em 4 categorias[1], sendo estas:
...
- **Gerencial:** Informações que associam requisitos elicitados à tar[efas](#efas) de sistema.
- **Desenvolvimento:** Informações relacionadas aos art[efat](#efat)os gerados durante o desenvolvimento do projeto.

Além das categorias, Toranzo também d[efin](#efin)e os elos em 6 tipos:
...
- **Responsabilidade:** Registra a participação, responsabilidade e ação de pessoas sobre art[efat](#efat)os.
...
## 5. R[efer](#efer)ências Bibliográficas
