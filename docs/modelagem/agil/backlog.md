...
|Cadastro de pet|  	US03 - 	Eu como usuário autenticado, gostaria de cadastrar um novo pet no aplicativo, para que possa solicitar serviços para ele.| Alta | [RF15](../../elicitacao/resultadoElicitacao.md#RF15), [RF29](../../elicitacao/resultadoElicitacao.md#RF29)|
...
|Repetir um pedido|US06 - Eu como usuário autenticado, gostaria de repetir uma compra prévia, para que possa economizar tempo em compras frequentes. | Alta | [RF06](../../elicitacao/resultadoElicitacao.md#RF06) |
|Realizar um pedido periódico|US07 - Eu como usuário autenticado, gostaria de configurar a compra automática de um pedido periódicamente, para que possa economizar tempo.| Alta | [RF20](../../elicitacao/resultadoElicitacao.md#RF20), [RF24](../../elicitacao/resultadoElicitacao.md#RF24), [RF33](../../elicitacao/resultadoElicitacao.md#RF33), [RF42](../../elicitacao/resultadoElicitacao.md#RF42)|
...
|Solicitar serviço de veterinária | US10 - Eu como usuário autenticado, gostaria de acompanhar e marcar consultas veterinárias para meu _pet_., para que possa economizar tempo. | Alta | [RF38](../../elicitacao/resultadoElicitacao.md#RF38), [RF41](../../elicitacao/resultadoElicitacao.md#RF41) |
|Solicitar serviço de hotelaria para animais|US11 - Eu como usuário autenticado, gostaria de acompanhar e realizar reservas de hospedagem para meu _pet_. para que possa economizar tempo. | Média |[RF43](../../elicitacao/resultadoElicitacao.md#RF43)|
|Solicitar serviço de transporte para animais |US12 - Eu como usuário autenticado, gostaria de acompanhar e solicitar o transporte do meu _pet_ até o estabelecimento físico, para que possa economizar tempo.  |Alta|[RF37](../../elicitacao/resultadoElicitacao.md#RF37)|
...
| Configuração e Cadastro | Épico 1 - Cadastro e autenticação |Cadastro de pet|  	US03 - 	Eu como usuário autenticado, gostaria de cadastrar um novo pet no aplicativo, para que possa solicitar serviços para ele.| Alta | [RF15](../../elicitacao/resultadoElicitacao.md#RF15), [RF29](../../elicitacao/resultadoElicitacao.md#RF29)|
...
| Venda | Épico 2 - Processo de realização de pedidos | Repetir um pedido|US06 - Eu como usuário autenticado, gostaria de repetir uma compra prévia, para que possa economizar tempo em compras frequentes. | Alta | [RF06](../../elicitacao/resultadoElicitacao.md#RF06) |
...
| Venda | Épico 3 - Serviços para o _pet_|Solicitar serviço de veterinária | US10 - Eu como usuário autenticado, gostaria de acompanhar e marcar consultas veterinárias para meu _pet_., para que possa economizar tempo. | Alta | [RF38](../../elicitacao/resultadoElicitacao.md#RF38), [RF41](../../elicitacao/resultadoElicitacao.md#RF41) |
| Venda | Épico 3 - Serviços para o _pet_|Solicitar serviço de hotelaria para animais|US11 - Eu como usuário autenticado, gostaria de acompanhar e realizar reservas de hospedagem para meu _pet_. para que possa economizar tempo. | Média |[RF43](../../elicitacao/resultadoElicitacao.md#RF43)|
| Venda | Épico 3 - Serviços para o _pet_|Solicitar serviço de transporte para animais |US12 - Eu como usuário autenticado, gostaria de acompanhar e solicitar o transporte do meu _pet_ até o estabelecimento físico, para que possa economizar tempo.  |Alta|[RF37](../../elicitacao/resultadoElicitacao.md#RF37)|
...
### Vídeo de priorização com cliente

<iframe width="560" height="315" src="https://www.youtube.com/watch?v=iM7UNU4F2i8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>


### Repriorização 

Após reunião com cliente, foi realizado a repriorização de alguns ítens do backlog.
...
| `1.3` | 05/07/2023 | Adicionar vídeo e repriorização dos requisitos com cliente | Samuel Sato | Pedro Ferreira |