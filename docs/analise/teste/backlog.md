...
#### 3.5.1 Verificação 1 - Os épicos definem um agrupamento coerente de histórias de usuário?
...
#### 3.5.2 Verificação 2 - A escrita das histórias de usuário possui o ator, a ação e a razão dessa ação?
...
#### 3.5.3 Verificação 4 - Os épicos são coerentes com o sistema analisado?
...
#### 3.5.4 Verificação 5 - O backlog do produto define temas?
