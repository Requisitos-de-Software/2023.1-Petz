...
As apresentações do projeto devem ser feitas assíncronamente e presencialmente. Para tanto, devem ser registradas em artefato próprio. 
...
#### 3.3.5 Verificação 9 - O histórico de versão possui autor(es) e revisor(es)?
...
#### 3.4.2 Verificação 6 - As páginas das apresentações marcam os membros presentes nas mesmas?
