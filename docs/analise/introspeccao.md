...
| ![Representação do grau de satisfação no artefato](../assets/analise/introspeccao1.png)               | ![Gráfico de ocorrência de erros no artefato](../assets/analise/introspeccao2.png)                 |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
